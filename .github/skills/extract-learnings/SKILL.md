...
**File location:**
- In azure-messaging-ai-context repo: `.github/general_coding_instructions.md`
- In higher-level repos: `deps/azure-messaging-ai-context/.github/general_coding_instructions.md`
...
### Step 8: Create PR to azure-messaging-ai-context

After updating `general_coding_instructions.md`, create a PR to the azure-messaging-ai-context repository with the changes:

1. **If working in azure-messaging-ai-context repo**: Create a branch and PR directly
2. **If working in a higher-level repo**: The changes are in `deps/azure-messaging-ai-context/.github/general_coding_instructions.md`. Create a PR to the [Azure/azure-messaging-ai-context](https://github.com/Azure/azure-messaging-ai-context) repository with the updated file.
